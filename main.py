...
class App:
    ...
    def login(self):
        ...
        if name in ["unknown_person", "no_persons_found"]:
            util.msg_box('Warning!!!', 'Unknown User!  PLease register new user or Try Again')
        else:
            util.msg_box('Welcome Back!', 'Hello, {}.'.format(name))
            # util.msg_box('Welcome Back!', 'Hello, registered user')
            with open(self.log_path, 'a') as f:
                ...
                webbrowser.open("https://github.com/agrawalrishabh008/Face-Recognition")
    ...
    def accept_register_new_user(self):
        ...
        util.msg_box('Success!', 'New User has been registered!')
